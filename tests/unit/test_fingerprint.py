"""Tests for sentinel.core.fingerprint — stable Finding ID generation."""
import pytest
...
class TestFingerprint:
    ...
    def test_same_code_same_fingerprint(self):
        from sentinel.core.fingerprint import generate_fingerprint
...
class TestFindingFingerprint:
    ...
    def test_fingerprint_from_finding(self):
        ...
        from sentinel.core.fingerprint import fingerprint_finding
